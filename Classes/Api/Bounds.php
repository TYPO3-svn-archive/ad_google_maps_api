 ...
 * @api
 */
class Tx_AdGoogleMapsApi_Api_Bounds {
	 ...
	 * Sets this southWest.
	 *
	 * @param Tx_AdGoogleMapsApi_Api_LatLng $southWest
	 * @return void
	 */
	public function setSouthWest(Tx_AdGoogleMapsApi_Api_LatLng $southWest) {
		$this->southWest = $southWest;
	}
	 ...
	 * Sets this northEast.
	 *
	 * @param Tx_AdGoogleMapsApi_Api_LatLng $northEast
	 * @return void
	 */
	public function setNorthEast(Tx_AdGoogleMapsApi_Api_LatLng $northEast) {
		$this->northEast = $northEast;
	}
	 ...
	 * 
	 * @param Tx_AdGoogleMapsApi_Api_LatLng $latLng
	 * @return void
	 */
	public function extend(Tx_AdGoogleMapsApi_Api_LatLng $latLng) {
	 ...
	 * 
	 * @param Tx_AdGoogleMapsApi_Api_LatLngArray $latLngArray
	 * @return void
	 */
	public function extendArray(Tx_AdGoogleMapsApi_Api_LatLngArray $latLngArray) {
