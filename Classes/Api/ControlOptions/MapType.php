 ...
 * @api
 */
class Tx_AdGoogleMapsApi_Api_ControlOptions_MapType extends Tx_AdGoogleMapsApi_Api_ControlOptions_AbstractControlOptions {
	...
	/**
	 * @var array
	 * @javaScriptHelper quoteValue = FALSE; quoteArrayValuesRecursively = TRUE
	 */
