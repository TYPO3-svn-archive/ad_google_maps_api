 ...
 * @api
 */
class Tx_AdGoogleMapsApi_Api_Layer_Marker extends Tx_AdGoogleMapsApi_Api_Layer_AbstractLayer {
	...
	/**
	 * @var Tx_AdGoogleMapsApi_Api_MarkerImage
	...
	/**
	 * @var Tx_AdGoogleMapsApi_Api_MarkerShape
	 * @javaScriptHelper getFunction = __toString; dontSetIfValueIs = 'null'
	 */
	protected $shape;
	 ...
	 * @return Tx_AdGoogleMapsApi_Api_Layer_Marker
	 */
	 ...
	 * Sets this position.
	 *
	 * @param Tx_AdGoogleMapsApi_Api_LatLng $position
	 * @return Tx_AdGoogleMapsApi_Api_Layer_Marker
	 */
	public function setPosition(Tx_AdGoogleMapsApi_Api_LatLng $position) {
	 ...
	 * Sets this icon.
	 *
	 * @param Tx_AdGoogleMapsApi_Api_MarkerImage $icon
	 * @return Tx_AdGoogleMapsApi_Api_Layer_Marker
	 */
	public function setIcon(Tx_AdGoogleMapsApi_Api_MarkerImage $icon) {
		$this->icon = $icon;
		return $this;
	}
	 ...
	 * Sets this shadow.
	 *
	 * @param Tx_AdGoogleMapsApi_Api_MarkerImage $shadow
	 * @return Tx_AdGoogleMapsApi_Api_Layer_Marker
	 */
	public function setShadow(Tx_AdGoogleMapsApi_Api_MarkerImage $shadow) {
		$this->shadow = $shadow;
		return $this;
	}
	 ...
	 * Sets this shape.
	 *
	 * @param Tx_AdGoogleMapsApi_Api_MarkerShape $shape
	 * @return Tx_AdGoogleMapsApi_Api_Layer_Marker
	 */
	public function setShape(Tx_AdGoogleMapsApi_Api_MarkerShape $shape) {
		$this->shape = $shape;
		return $this;
	}
	 ...
	 * Returns this shape.
	 *
	 * @return Tx_AdGoogleMapsApi_Api_MarkerShape
	 */
