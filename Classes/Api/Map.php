 ...
 * @api
 */
class Tx_AdGoogleMapsApi_Api_Map {
	...
	/**
	 * @var Tx_AdGoogleMapsApi_Api_LatLng
	...
	/**
	 * @var Tx_AdGoogleMapsApi_Api_ControlOptions_MapType
	...
	/**
	 * @var Tx_AdGoogleMapsApi_Api_ControlOptions_Navigation
	 * @javaScriptHelper dontSetIfValueIs = 'null'
	 */
	...
	/**
	 * @var Tx_AdGoogleMapsApi_Api_ControlOptions_Scale
	 * @javaScriptHelper dontSetIfValueIs = 'null'
	 */
	...
	/**
	 * @var Tx_AdGoogleMapsApi_Api_ControlOptions_Pan
	 * @javaScriptHelper dontSetIfValueIs = 'null'
	 */
	...
	/**
	 * @var Tx_AdGoogleMapsApi_Api_ControlOptions_StreetView
	 * @javaScriptHelper dontSetIfValueIs = 'null'
	 */
	 ...
	 * @return Tx_AdGoogleMapsApi_Api_Map
	 */
	public function setCenter(Tx_AdGoogleMapsApi_Api_LatLng $center) {
		$this->center = $center;
		return $this;
	}
	 ...
	 *
	 * @param Tx_AdGoogleMapsApi_Api_ControlOptions_MapType $mapTypeControlOptions
	 * @return Tx_AdGoogleMapsApi_Api_Map
	 */
	public function setMapTypeControlOptions(Tx_AdGoogleMapsApi_Api_ControlOptions_MapType $mapTypeControlOptions) {
	 ...
	 *
	 * @return Tx_AdGoogleMapsApi_Api_ControlOptions_MapType
	 */
	 ...
	 *
	 * @param Tx_AdGoogleMapsApi_Api_ControlOptions_Navigation $navigationControlOptions
	 * @return Tx_AdGoogleMapsApi_Api_Map
	 */
	public function setNavigationControlOptions(Tx_AdGoogleMapsApi_Api_ControlOptions_Navigation $navigationControlOptions) {
	 ...
	 *
	 * @return Tx_AdGoogleMapsApi_Api_ControlOptions_Navigation
	 */
	 ...
	 *
	 * @param Tx_AdGoogleMapsApi_Api_ControlOptions_Scale $scaleControlOptions
	 * @return Tx_AdGoogleMapsApi_Api_Map
	 */
	public function setScaleControlOptions(Tx_AdGoogleMapsApi_Api_ControlOptions_Scale $scaleControlOptions) {
	 ...
	 *
	 * @return Tx_AdGoogleMapsApi_Api_ControlOptions_Scale
	 */
	 ...
	 *
	 * @param Tx_AdGoogleMapsApi_Api_ControlOptions_Pan $panControlOptions
	 * @return Tx_AdGoogleMapsApi_Api_Map
	 */
	public function setPanControlOptions(Tx_AdGoogleMapsApi_Api_ControlOptions_Pan $panControlOptions) {
	 ...
	 *
	 * @return Tx_AdGoogleMapsApi_Api_ControlOptions_Pan
	 */
	 ...
	 *
	 * @param Tx_AdGoogleMapsApi_Api_ControlOptions_Zoom $zoomControlOptions
	 * @return Tx_AdGoogleMapsApi_Api_Map
	 */
	public function setZoomControlOptions(Tx_AdGoogleMapsApi_Api_ControlOptions_Zoom $zoomControlOptions) {
	 ...
	 *
	 * @return Tx_AdGoogleMapsApi_Api_ControlOptions_Zoom
	 */
	 ...
	 *
	 * @param Tx_AdGoogleMapsApi_Api_ControlOptions_StreetView $streetViewControlOptions
	 * @return Tx_AdGoogleMapsApi_Api_Map
	 */
	public function setStreetViewControlOptions(Tx_AdGoogleMapsApi_Api_ControlOptions_StreetView $streetViewControlOptions) {
	 ...
	 *
	 * @return Tx_AdGoogleMapsApi_Api_ControlOptions_StreetView
	 */
	...
	public function getPrintOptions() {
		return Tx_AdGoogleMapsApi_Utility_BackEnd::getClassAsJsonObject($this, TRUE);
	}
	...
	public function getPrint() {
		return sprintf('new google.maps.Map(document.getElementById(\'%s\', %s)', $this->canvas, Tx_AdGoogleMapsApi_Utility_BackEnd::getClassAsJsonObject($this));
	}
