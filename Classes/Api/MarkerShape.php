 ...
 * @api
 */
class Tx_AdGoogleMapsApi_Api_MarkerShape {
	 ...
	 * @throw Tx_AdGoogleMapsApi_Exception
	 */
	public function setType($type) {
		if (in_array($shape, array('', 'circle', 'poly', 'rect')) === FALSE) {
			throw new Tx_AdGoogleMapsApi_Exception('Invalid parameter value for Tx_AdGoogleMapsApi_Api_MarkerShape::setType(), "' . $type . '" given', 1294069168);
		}
		$this->type = $type;
		return $this;
	}
