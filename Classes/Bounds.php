 ...
 * @package Extbase
 * @subpackage GoogleMapsAPI\Bounds
 * @scope prototype
 * @entity
 * @api
 */
class Tx_AdGoogleMapsApi_Bounds {
	 ...
	 * Sets this southWest.
	 *
	 * @param Tx_AdGoogleMapsApi_LatLng $southWest
	 * @return void
	 */
	public function setSouthWest(Tx_AdGoogleMapsApi_LatLng $southWest) {
		$this->southWest = $southWest;
	}
	 ...
	 * Sets this northEast.
	 *
	 * @param Tx_AdGoogleMapsApi_LatLng $northEast
	 * @return void
	 */
	public function setNorthEast(Tx_AdGoogleMapsApi_LatLng $northEast) {
		$this->northEast = $northEast;
	}
	 ...
	 * 
	 * @param Tx_AdGoogleMapsApi_LatLng $latLng
	 * @return void
	 */
	public function extend(Tx_AdGoogleMapsApi_LatLng $latLng) {
	 ...
	 * 
	 * @param Tx_AdGoogleMapsApi_LatLngArray $latLngArray
	 * @return void
	 */
	public function extendArray(Tx_AdGoogleMapsApi_LatLngArray $latLngArray) {
	...
	public function getPrint() {
		return ($this->southWest || $this->northEast) ? 'new google.maps.LatLngBounds(' . ($this->southWest ? $this->southWest : 'null') . ', ' . ($this->northEast ? $this->northEast : 'null') . ')' : 'null';
	}
