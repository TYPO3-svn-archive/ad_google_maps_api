 ...
 * @api
 */
class Tx_AdGoogleMapsApi_ControlOptions_Pan extends Tx_AdGoogleMapsApi_ControlOptions_AbstractControlOptions {
	...
	/**
	 * Returns panControl options as JavaScript string.
	 *
	 * @return string
	 */
	...
	public function getPrint() {
		return 'panControlOptions: { ' . $this->getPrintOptions() . ' }';
	}
