 ...
 * @package Extbase
 * @subpackage GoogleMapsAPI\Layers\InfoWindow
 * @scope prototype
 * @entity
 * @api
 */
class Tx_AdGoogleMapsApi_Layers_InfoWindow extends Tx_AdGoogleMapsApi_Layers_AbstractLayer {
	 ...
	 * @return Tx_AdGoogleMapsApi_Layers_InfoWindow
	 */
