 ...
 * @package Extbase
 * @subpackage GoogleMapsAPI\Layers\Marker
 * @scope prototype
 * @entity
 * @api
 */
class Tx_AdGoogleMapsApi_Layers_Marker extends Tx_AdGoogleMapsApi_Layers_AbstractLayer {
	 ...
	 * @return Tx_AdGoogleMapsApi_Layers_Marker
	 */
	...
	public function setShape($shape) {
		if (in_array($shape, array('', 'circle', 'poly', 'rect')) === FALSE) {
			throw new Tx_AdGoogleMapsApi_Exception('Invalid parameter value for Tx_AdGoogleMapsApi_Layers_Marker::setShape(), "' . $shape . '" given', 1294069168);
		}
		$this->shape = $shape;
		return $this;
	}
