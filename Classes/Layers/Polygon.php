 ...
 * @package Extbase
 * @subpackage GoogleMapsAPI\Layers\Polygon
 * @scope prototype
 * @entity
 * @api
 */
class Tx_AdGoogleMapsApi_Layers_Polygon extends Tx_AdGoogleMapsApi_Layers_AbstractLayer {
	 ...
	 * @return Tx_AdGoogleMapsApi_Layers_Polygon
	 */
