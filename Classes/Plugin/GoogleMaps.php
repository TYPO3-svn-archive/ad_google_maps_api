...
class Tx_AdGoogleMapsApi_Plugin_GoogleMaps {
	...
	public function getPluginOptionsObjectIdentifier() {
		return $this->mapId ? 'Tx_AdGoogleMapsApi_Plugin_Options_Uid' . $this->mapId : 'Tx_AdGoogleMapsApi_Plugin_Options';
	}
	...
	public function getPluginMapObjectIdentifier() {
		return $this->mapId ? 'Tx_AdGoogleMapsApi_Plugin_Map_Uid' . $this->mapId : 'Tx_AdGoogleMapsApi_Plugin_Map';
	}
