 ...
 * @api
 */
class Tx_AdGoogleMapsApi_Plugin_Options_Layer_InfoWindow extends Tx_AdGoogleMapsApi_Plugin_Options_Layer_AbstractLayer {
	 ...
	 * @return Tx_AdGoogleMapsApi_Plugin_Options_Marker
	 */
