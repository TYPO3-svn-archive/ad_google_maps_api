...
class tx_AdGoogleMapsApi_Service_MapDrawer {
	...
	protected static $supportedLayerTypes = array(
		'Tx_AdGoogleMaps_PluginAdapter_LayerBuilder_Marker',
		'Tx_AdGoogleMaps_PluginAdapter_LayerBuilder_Polyline',
		'Tx_AdGoogleMaps_PluginAdapter_LayerBuilder_Polygon',
	);
	...
	public function user_parseCoordinatesField($currentField, $formObject) {
		...
		$shapeOptions = array();
		if ($layerType === 'Tx_AdGoogleMaps_PluginAdapter_LayerBuilder_Polyline' || $layerType === 'Tx_AdGoogleMaps_PluginAdapter_LayerBuilder_Polygon') {
		...
		if ($layerType === 'Tx_AdGoogleMaps_PluginAdapter_LayerBuilder_Polygon') {
	...
	protected function getGoogleMapsApiUrl() {
		...
		return $this->settings['googleMaps']['apiUrl'] . '?sensor=false' . $language;
	}
