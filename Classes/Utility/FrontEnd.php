 ...
 */
class Tx_AdGoogleMapsApi_Utility_FrontEnd extends Tx_AdGoogleMapsApi_Utility_BackEnd {
	 ...
	 * @var array
	 */
	public static $loadedFrontEndResources = array();
	...
	public static function includeFrontEndResources($configurationKey) {
		if (array_key_exists($configurationKey, self::$loadedFrontEndResources) === FALSE && ($settings = Tx_AdGoogleMapsApi_Utility_BackEnd::loadSettings($GLOBALS['TSFE']->id, 'tx_adgooglemapsapi')) !== FALSE) {
