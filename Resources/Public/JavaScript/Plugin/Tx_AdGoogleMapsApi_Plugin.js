...
Tx_AdGoogleMapsApi_Plugin.prototype = {
	options: null,
	canvasId: null,
	canvas: null,
	...
	construct: function(options){
		...
		if (this.mapControl.useMarkerCluster === true){
			if (typeof(MarkerClusterer) === 'undefined'){
				...
				console.log('Error Tx_AdGoogleMapsApi_Plugin.construct(): MarkerClusterer Lib not loaded.');
			} else {
	...
	setLayer: function(layerUid, layerOptions){
		return this.layers[layerUid] = new Tx_AdGoogleMapsApi_Plugin_LayerObject(layerOptions);
	},
 ...
 * Layer object.
 */
Tx_AdGoogleMapsApi_Plugin_LayerObject = function(options){
	this.construct(options);
};
Tx_AdGoogleMapsApi_Plugin_LayerObject.prototype = {
	options: null,
	layer: null,
	center: null,
	bounds: null,
 ...
 * Marker Extension.
 */
Tx_AdGoogleMapsApi_Plugin.prototype.opendInfoWindows = {};
Tx_AdGoogleMapsApi_Plugin.prototype.drawInfoWindow = function(layerIndex){
	var _this = this;
...
Tx_AdGoogleMapsApi_Plugin.prototype.openInfoWindow = function(layerUid, event){
...
Tx_AdGoogleMapsApi_Plugin.prototype.closeInfoWindow = function(layerUid){
	if (this.opendInfoWindows[layerUid] === undefined)
		return;
...
Tx_AdGoogleMapsApi_Plugin.prototype.closeAllInfoWindows = function(){
 ...
 * Marker Extension.
 */
Tx_AdGoogleMapsApi_Plugin.prototype.drawMarker = function(layerIndex){
	var _this = this;
	var layerOptions = this.getLayerOptions(layerIndex);
	var layerUid = layerOptions.uid;
	// Set layer object.
...
__Tx_AdGoogleMapsApi_Plugin = function(options){
	var _this = this;
			...
			if (status == google.maps.GeocoderStatus.OK) {
				if (_this.searchMarker === null){
					var searchMarkerOptions = {
						...
						icon: _this.mapControlOptions.searchMarker,
						zIndex: 999
					};
