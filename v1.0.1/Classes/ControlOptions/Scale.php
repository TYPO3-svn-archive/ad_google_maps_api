 ...
 * @api
 */
class Tx_AdGoogleMapsApi_ControlOptions_Scale extends Tx_AdGoogleMapsApi_ControlOptions_AbstractControlOptions {
	...
	public function __construct($position = NULL, $style = NULL) {
		$this->setPosition($position ? $position : self::POSITION_BOTTOM_LEFT);
	...
	/**
	 * Returns scaleControl options as JavaScript string.
	 *
	 * @return string
	 */
	public function getPrintOptions() {
		$options = array();
		if ($this->position !== self::POSITION_BOTTOM_LEFT) {
	...
	public function getPrint() {
		return 'scaleControlOptions: { ' . $this->getPrintOptions() . ' }';
	}
